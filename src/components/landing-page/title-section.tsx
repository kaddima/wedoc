  ...
  return (
    <>
        <section className='flex flex-col gap-4 justify-center items-start md:items-center'>
            <article className='rounded-full p-[1px] text-sm dark:bg-gradient-to-t 
            ...
            {subheading ? 
            <>
                <h2 className='text-left text-3xl sm:text-5xl sm:max-w-[750px] 
                md:text-center font-semibold' > {title}</h2>
                <p className='dark:text-washed-blue-700 sm:max-w-[450px] md:text-center'>
                    {subheading}
                </p>
            </> : <h1 className='text-left text-4xl sm:text-6xl sm:max-w-[850px] 
